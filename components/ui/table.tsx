...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={`border-t bg-gray-100 dark:bg-gray-800 font-medium ${className || ""}`}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={`border-b transition-colors hover:bg-gray-100/50 dark:hover:bg-gray-800/50 ${className || ""}`}
    {...props}
  />
));
